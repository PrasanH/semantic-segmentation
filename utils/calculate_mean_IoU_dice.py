...
"""
Calculates scores like mIoU and mean dice scores for 2 image folders: ground truth and predicted labels (Uses GPU)

calculates image wise and then calculates mean

Make sure to correctly define the class colours for actual and predicted 

The file-wise scores are logged into a csv file. Check for the path below
...
def calculate_metrics_on_gpu(actual_path, predicted_path, color_map_actual, color_map_predicted, use_gpu=True):
    ...
    output_file = os.path.join(output_dir, "4_segmentation_metrics_ienet2_380k.csv")
...
#simulated images
actual_folder = "/home/pdhegde/semseg_git_fork/semantic-segmentation/data/Nov_24/nov_24_img_labels/test/labels/"

predicted_folder = "/home/pdhegde/semseg_git_fork/semantic-segmentation/out/NOV25_BASE/6_resnet101_nov4_e15_526_default"

#test images
#actual_folder = "/home/pdhegde/semseg_git_fork/semantic-segmentation/data/unreal_images/test/labels/"
#predicted_folder = "/home/pdhegde/semseg_git_fork/semantic-segmentation/out/6_resnet101_nov4_e15_526_default/test/" 
